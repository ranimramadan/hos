        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="p-16 md:w-1/2">
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-500 mb-4">or register with social platforms</p>
              <div className="flex justify-center gap-4">
                <a href="#" className="p-3 border rounded-full hover:bg-gray-50 transition-colors duration-300">
