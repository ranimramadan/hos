          ...
          <div className="bg-white rounded-xl shadow-sm p-4 sticky top-8">
            {tabs.map(tab => (
              <button
                ...
                className={`w-full text-right px-4 py-3 rounded-lg transition-all duration-200 mb-2 flex items-center gap-3 ${
                  activeTab === tab.id 
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-100">
            ...
            {activeTab === 'notifications' && (
              <div className="space-y-8">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    <h3 className="text-gray-900 font-medium">تفعيل الإشعارات</h3>
                    <p className="text-gray-500 text-sm mt-1">استلام إشعارات النظام</p>
                  </div>
            ...
            {activeTab === 'security' && (
              <div className="space-y-8">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    <h3 className="text-gray-900 font-medium">النسخ الاحتياطي التلقائي</h3>
                    <p className="text-gray-500 text-sm mt-1">تفعيل النسخ الاحتياطي التلقائي للنظام</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
