...
import { Linkedin, Youtube, Facebook, MapPin, GraduationCap, Stethoscope , Mail, Phone} from 'lucide-react';
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="bg-red-50 p-2 rounded-full hover:bg-blue-100 transition-colors">
                <Mail size={24} className="text-red-600" />
              </a>
              <a href="#" className="bg-green-50 p-2 rounded-full hover:bg-red-100 transition-colors">
